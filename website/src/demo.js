...
export function mountDemo(element, { locale = document.documentElement.lang || "es" } = {}) {
  ...
  function reset() {
    ...
    cancelDrag();
    close();
    element.dispatchEvent(new CustomEvent("demo:reset", { bubbles: true }));
    Object.assign(state, {
      open: null,
      shelf: [],
      delivered: [],
